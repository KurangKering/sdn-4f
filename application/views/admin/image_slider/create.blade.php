...
<div class="content">
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ site_url('admin/image-slider/save') }}">
				<fieldset class="content-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea required name="caption" class="form-control">{{ $data ? $data->caption : '' }}</textarea>
						</div>
					</div>
					<div class="form-group">
