					...
					<div class="panel-body">
						...
						<fieldset class="content-group">
							...
							<div class="form-group">
								<div class="col-lg-12">
									<input type="text" name="post_title" id="post_title" placeholder="Judul Berita" value="{{ $query ? $query->judul : '' }}" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-12">
									<textarea rows="25" id="post_content" name="post_content" class="form-control ckeditor">{!! ($query ? $query->konten : '') !!}</textarea>
								</div>
							</div>
						</fieldset>
					</div>
	...
	function submit_posts() {
		...
		$.ajax({
			...
			success : function( response ) {
				...
				location.href='{{ site_url('admin/berita') }}';
