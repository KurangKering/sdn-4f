	...
	<div class="page-header-content">
		...
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="{{ site_url('admin/quote/create') }}" class="btn btn-link btn-float has-text"><i class="icon-add text-primary"></i><span>Tambah Kata Bijak</span></a>
	...
	<div class="panel panel-flat">
		...
		<table class="table datatable-basic">
			...
			<tbody>
				...
				<tr>
					<td style="width: 1%; white-space: nowrap">{{ $kata->oleh }}</td>
					<td>{{ $kata->quote }}</td>
					<td style="width: 1%; white-space: nowrap">
						<a href="{{ site_url('admin/quote/create/'.$kata->id) }}" class="btn btn-success">Edit</a>
						<form action="{{ site_url('admin/quote/delete') }}" method="POST" style="display: inline">
