	...
	<div class="page-header-content">
		...
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="<?php echo e(site_url('admin/berita/create')); ?>" class="btn btn-link btn-float has-text"><i class="icon-add text-primary"></i><span>Tambah Berita</span></a>
	...
	<div class="panel panel-flat">
		...
		<table class="table datatable-basic">
			...
			<tbody>
				...
				<tr>
					<td style="width: 1%;white-space: nowrap;"><?php echo e($berita->id); ?></td>
					<td style="width: 1%;white-space: nowrap;">
						...
						<ul>
							...
							<li><?php echo e($data_kategori[$kategori]); ?></li>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</ul>

					</td>
					<td><?php echo e($berita->judul); ?></td>
					<td style="white-space: nowrap;width:1%"><img src="<?php echo e(site_url('media/berita/thumbnail/'.$berita->berita_image)); ?>" alt=""></td>
					<td width="1%" style="white-space: nowrap;">
						<a href="<?php echo e(site_url('admin/berita/komentar/'.$berita->id)); ?>" class="btn btn-info">Komentar</a>
						<a href="<?php echo e(site_url('admin/berita/create/'.$berita->id)); ?>" class="btn btn-success">Edit</a>

						<form action="<?php echo e(site_url('admin/berita/delete')); ?>" method="POST" style="display: inline">
