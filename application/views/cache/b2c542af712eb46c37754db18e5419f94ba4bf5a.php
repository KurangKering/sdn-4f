...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> Daftar Komentar Berita ID: <?php echo e($berita->id); ?></h4>
		</div>
	...
	<div class="panel panel-flat">
		...
		<table class="table datatable-basic">
			...
			<tbody>
				...
				<tr>
					<td style="width: 1%;white-space: nowrap;"><?php echo e($komentar->nama); ?></td>
					
					<td><?php echo e($komentar->email); ?></td>
					<td><?php echo e($komentar->komentar); ?></td>
					<td width="1%" style="white-space: nowrap;">

						<form action="<?php echo e(site_url('admin/berita/hapus_komentar_berita')); ?>" method="POST" style="display: inline">
							<input type="hidden" name="id" value="<?php echo e($komentar->id); ?>">
