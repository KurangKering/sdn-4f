					...
					<div class="panel-body">
						...
						<fieldset class="content-group">
							...
							<div class="form-group">
								<div class="col-lg-12">
									<textarea rows="25" id="post_content" name="post_content" class="form-control ckeditor"><?php echo ($query ? $query->isi : ''); ?></textarea>
								</div>
							</div>
						</fieldset>
...
<script type="text/javascript">
	...
	function submit_posts() {
		...
		fill_data.append('title', 'ekstrakulikuler');
