...
<div class="card rounded-0 border border-secondary mb-3">
	...
	<div class="card-body">
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<?php $num = 1; ?>
				<?php $__currentLoopData = $dataStrukturOrganisasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
