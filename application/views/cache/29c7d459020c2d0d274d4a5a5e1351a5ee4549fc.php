        ...
        <nav class="navbar navbar-expand-lg p-0">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul id="main-menu" class="sm sm-clean">
              ...
              <li>
                <a href="<?php echo e(site_url('pages/profil')); ?>" target="_self">PROFIL
                </a>
              </li>

              <li>
                <a href="#" target="_self">PROFIL
                </a>
                <ul>
                  <li>
                  ...
                  <li>
                    <a href="<?php echo e(site_url('#')); ?>" target="_self">Struktur Organisasi
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo e(site_url('#')); ?>" target="_self">Data Guru Dan Pegawai
                    </a>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <a href="<?php echo e(site_url('#')); ?>" target="_self">RUANGAN
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo e(site_url('#')); ?>" target="_self">ELEKTRONIK
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo e(site_url('#')); ?>" target="_self">MOUBILER
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo e(site_url('#')); ?>" target="_self">NVENTARIS
                    </a>
                  </li>
              ...
              <li>
                <a href="<?php echo e(site_url('berita/page/1')); ?>" target="_self">PRESTASI</a>
              </li>
              <li>
                <a href="<?php echo e(site_url('berita/page/1')); ?>" target="_self">EKSTRAKULIKULER</a>
              </li>
              <li>
