...
<div class="content">
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<?php endif; ?>
			<form class="form-horizontal"  method="POST" action="<?php echo e(site_url('admin/kategori_berita/save')); ?>">
				<fieldset class="content-group">
					<input type="hidden" name="id" value="<?php echo e($data ? $data->id : ''); ?>">
					<div class="form-group">
						<label class="control-label col-lg-2">Kategori</label>
						<div class="col-lg-10">
							<input type="text" name="kategori" required value="<?php echo e($data ? $data->kategori : ''); ?>" class="form-control">
						</div>
					</div>
				</fieldset>
