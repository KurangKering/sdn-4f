							...
							<ul class="navigation navigation-main navigation-accordion"><!-- Main -->
								...
								<li>
									...
									<ul>
										...
										<li><a href="<?php echo e(site_url('admin/data_guru_pegawai')); ?>"><span>Data Guru & Pegawai</span></a></li>
										<li><a href="<?php echo e(site_url('admin/struktur_organisasi')); ?>"><span>Struktur Organisasi</span></a></li>
										<li><a href="<?php echo e(site_url('admin/fasilitas/ruangan')); ?>"><span>Ruangan</span></a></li>
										<li><a href="<?php echo e(site_url('admin/fasilitas/elektronik')); ?>"><span>Elektronik</span></a></li>
										<li><a href="<?php echo e(site_url('admin/fasilitas/moubiler')); ?>"><span>Moubiler</span></a></li>
										<li><a href="<?php echo e(site_url('admin/fasilitas/inventaris')); ?>"><span>Inventaris</span></a></li>
										<li><a href="<?php echo e(site_url('admin/prestasi')); ?>"><span>Prestasi</span></a></li>
										<li><a href="<?php echo e(site_url('admin/ekstrakulikuler')); ?>"><span>Ekstrakulikuler</span></a></li>
								...
								<li>
									...
									<ul>
										...
										<li><a href="<?php echo e(site_url('admin/video')); ?>">Video</a></li>
									</ul>
								</li>
