	...
	<div class="page-header-content">
		...
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="<?php echo e(site_url('admin/image-slider/create')); ?>" class="btn btn-link btn-float has-text"><i class="icon-add text-primary"></i><span>Tambah Image</span></a>
	...
	<div class="panel panel-flat">
		...
		<table class="table datatable-basic">
			...
			<tbody>
				...
				<tr>
					<td style="width: 1%;white-space: nowrap;"><?php echo e($slider->id); ?></td>
					<td><?php echo e($slider->caption); ?></td>
					<td style="white-space: nowrap;width:1%"><img style="width: 150px; height: 100px;" src="<?php echo e(site_url('media/sliders/'.$slider->url)); ?>" alt=""></td>
					<td width="1%" style="white-space: nowrap;">
						<a href="<?php echo e(site_url('admin/image-slider/create/'.$slider->id)); ?>" class="btn btn-success">Edit</a>

						<form action="<?php echo e(site_url('admin/image-slider/delete')); ?>" method="POST" style="display: inline">
