	...
	<div class="page-header-content">
		...
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="<?php echo e(site_url('admin/kategori_berita/create')); ?>" class="btn btn-link btn-float has-text"><i class="icon-add text-primary"></i><span>Tambah Kategori Berita</span></a>
	...
	<div class="panel panel-flat">
		...
		<table class="table datatable-basic">
			...
			<tbody>
				...
				<tr>
					<td style="width: 1%;white-space: nowrap;"><?php echo e($kategori->id); ?></td>
					<td><?php echo e($kategori->kategori); ?></td>
					<td width="1%" style="white-space: nowrap;">
						<a href="<?php echo e(site_url('admin/kategori_berita/create/'.$kategori->id)); ?>" class="btn btn-success">Edit</a>

						<form action="<?php echo e(site_url('admin/kategori_berita/delete')); ?>" method="POST" style="display: inline">
