...
<div class="content">
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo e(site_url('admin/album-photo/save')); ?>">
				<fieldset class="content-group">
					<input type="hidden" name="id" value="<?php echo e($data ? $data->id : ''); ?>">
					<div class="form-group">
						<label class="control-label col-lg-2">Judul</label>
						<div class="col-lg-10">
							<input required type="text" name="title" value="<?php echo e($data ? $data->title : ''); ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-2">Deskripsi</label>
						<div class="col-lg-10">
							<textarea required name="description" class="form-control"><?php echo e($data ? $data->description : ''); ?></textarea>
						</div>
					</div>
					<div class="form-group">
