...
DROP DATABASE IF EXISTS `sdn-afri`;
...
INSERT INTO `album_photo` (`id`, `title`, `description`, `cover`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `berita` (`id`, `kategori_berita_id`, `judul`, `konten`, `author_user_id`, `created_at`, `updated_at`, `berita_image`) VALUES
...
DROP TABLE IF EXISTS `data_guru_pegawai`;
...
DELETE FROM `data_guru_pegawai`;
/*!40000 ALTER TABLE `data_guru_pegawai` DISABLE KEYS */;
INSERT INTO `data_guru_pegawai` (`id`, `nama`, `jabatan`, `created_at`, `updated_at`) VALUES
...
DELETE FROM `hubungi_kami`;
/*!40000 ALTER TABLE `hubungi_kami` DISABLE KEYS */;
INSERT INTO `hubungi_kami` (`id`, `nama`, `email`, `pesan`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `image_slider` (`id`, `url`, `caption`, `created_at`, `updated_at`) VALUES
...
DELETE FROM `komentar_berita`;
/*!40000 ALTER TABLE `komentar_berita` DISABLE KEYS */;
INSERT INTO `komentar_berita` (`id`, `berita_id`, `komentar`, `nama`, `email`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `pages` (`id`, `title`, `isi`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `pengaturan` (`id`, `nama`, `nilai`, `keterangan`, `created_at`, `updated_at`) VALUES
	...
	(7, 'foto_kepsek', 'd2e16cfae727208c77a72ec628c9f57a.jpg', 'Foto Kepala Sekolah', '2019-05-16 13:32:07', '2019-05-16 13:49:32');
...
INSERT INTO `photos` (`id`, `caption`, `album_photo_id`, `url`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `quotes` (`id`, `quote`, `oleh`, `created_at`, `updated_at`) VALUES
...
DROP TABLE IF EXISTS `relasi_berita_kategori`;
...
DELETE FROM `relasi_berita_kategori`;
/*!40000 ALTER TABLE `relasi_berita_kategori` DISABLE KEYS */;
INSERT INTO `relasi_berita_kategori` (`berita_id`, `kategori_id`) VALUES
	(24, 8);
